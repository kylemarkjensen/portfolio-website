...
<div style="display: flex; gap: 16px; width: 100%; align-items: stretch; margin: 25px 0;">
  ...
  <div style="flex: 1; display: flex;">
    <img src="/images/cv/AD_walk_1.jpeg" alt="Left project image" style="width: 100%; height: 100%; object-fit: cover;">
  </div>

  <!-- middle Image Wrapper -->
  <div style="flex: 1; display: flex;">
    <img src="/images/cv/AD_walk_2.jpeg" alt="Left project image" style="width: 100%; height: 100%; object-fit: cover;">
  </div>
...
<iframe src="https://act.alz.org/site/SPageServer?pagename=walk_homepage" width="100%" height="500px" style="border:none;">
